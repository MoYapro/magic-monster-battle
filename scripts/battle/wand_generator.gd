...
static func _pick_body_spell(rng: RandomNumberGenerator) -> SpellData:
	var spells: Array[SpellData] = [
		SpellData.new("Ember",   "Em",  ["fire"],    Color(1.00, 0.45, 0.10), [], "", 3),
		SpellData.new("Frost",   "Fr",  ["water"],   Color(0.25, 0.65, 1.00), [], "", 2),
		SpellData.new("Venom",   "Vn",  ["poison"],  Color(0.30, 0.85, 0.20), [], "", 2),
		SpellData.new("Amplify", "Amp", ["amplify"], Color(0.80, 0.30, 1.00), [], "", 5),
		SpellData.new("Shield",  "Sh",  ["shield"],  Color(0.65, 0.75, 0.90), [], "", 0),
	]
